...
Inmate.create(first_name: 'Victor', last_name: 'Fries', nick_name: 'Mr. Freeze', mugshot: 'http://i.imgur.com/MiLqE9J.jpg', bio: freeze_bio)
Inmate.create(first_name: 'Edward', last_name: 'Nigma', nick_name: 'Riddler', mugshot: 'http://i.imgur.com/9ztYqXq.jpg', bio: riddler_bio)
Inmate.create(first_name: 'Oswald', last_name: 'Cobblepot', nick_name: 'Penguin', mugshot: 'http://i.imgur.com/0CVug21.jpg', bio: penguin_bio)
Inmate.create(first_name: 'N/A', last_name: 'Dorrance', nick_name: 'Bane', mugshot: 'http://i.imgur.com/Byv9IM1.jpg', bio: bane_bio)
Inmate.create(first_name: 'Jonathan', last_name: 'Crane', nick_name: 'Scarecrow', mugshot: 'http://i.imgur.com/HLsk5VW.jpg', bio: scarecrow_bio)
Inmate.create(first_name: 'N/A', last_name: 'N/A', nick_name: 'Joker', mugshot: 'http://i.imgur.com/t8r9IDC.jpg', bio: joker_bio)
